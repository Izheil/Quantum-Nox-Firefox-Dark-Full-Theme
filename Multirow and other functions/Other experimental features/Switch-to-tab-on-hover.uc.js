...
// This specifies the delay time to leave the mouse over an element before it switches to it
// Use miliseconds. 1 second = 1000 miliseconds.
var delayBeforeSwitch = 0;
...
function hoverHandler(e){
  ...
  setTimeout(function(){EvEl.addEventListener('mouseover', switchToTab, false)}, delayBeforeSwitch)
  setTimeout(function(){EvEl.removeEventListener('mouseover', switchToTab, false)}, delayBeforeSwitch + 500)
}
