...
scrollbar thumb[orient="horizontal"]:hover {
	background: linear-gradient(transparent 0, transparent 1px, #2f832f 1px, #1b4b1b 11px, transparent 11px, transparent 12px) !important;
}

scrollbar:hover thumb[orient="vertical"],
scrollbar thumb[orient="vertical"]:hover {
	background: linear-gradient(to right, transparent 0, transparent 1px, #2f832f 1px, #1b4b1b 11px, transparent 11px, transparent 12px) !important;
}
