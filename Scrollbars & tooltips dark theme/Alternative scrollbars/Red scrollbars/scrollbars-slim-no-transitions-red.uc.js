...
scrollbar thumb[orient="horizontal"]:hover {
	background: linear-gradient(transparent 0, transparent 1px, #832f2f 1px, #381414 11px, transparent 11px, transparent 12px) !important;
}

scrollbar:hover thumb[orient="vertical"],
scrollbar thumb[orient="vertical"]:hover {
	background: linear-gradient(to right, transparent 0, transparent 1px, #832f2f 1px, #381414 11px, transparent 11px, transparent 12px) !important;
}

scrollbar thumb[orient="vertical"]:active {
	background: linear-gradient(to right, #832f2f, #130707) !important;
	border-radius: 6px !important;
}

scrollbar thumb[orient="horizontal"]:active {
	background: linear-gradient(#832f2f, #130707) !important;
	border-radius: 6px !important;
}
