...
scrollbar thumb[orient="horizontal"]:hover {
	background: linear-gradient(transparent 0, transparent 1px, #c60 1px, #804000 11px, transparent 11px, transparent 12px) !important;
}

scrollbar:hover thumb[orient="vertical"],
scrollbar thumb[orient="vertical"]:hover {
	background: linear-gradient(to right, transparent 0, transparent 1px, #c60 1px, #804000 11px, transparent 11px, transparent 12px) !important;
}

scrollbar thumb[orient="vertical"]:active {
	background: linear-gradient(to right, #c60, #663300) !important;
	border-radius: 6px !important;
}

scrollbar thumb[orient="horizontal"]:active {
	background: linear-gradient(#c60, #663300) !important;
	border-radius: 6px !important;
}
