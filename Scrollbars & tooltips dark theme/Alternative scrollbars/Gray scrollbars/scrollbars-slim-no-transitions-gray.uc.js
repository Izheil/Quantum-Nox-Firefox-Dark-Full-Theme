...
scrollbar thumb[orient="vertical"] {
	...
	min-width: 12px !important;
	max-width: 12px !important;
	background: linear-gradient(to right, transparent 0, transparent 1px, #888 1px, #333 11px, transparent 11px, transparent 12px) !important;
}
...
scrollbar thumb[orient="horizontal"] {
	...
	min-height: 12px !important;
	max-height: 12px !important;
	background: linear-gradient(transparent 0, transparent 1px, #888 1px, #333 11px, transparent 11px, transparent 12px) !important;
}
...
scrollbar thumb[orient="vertical"]:active {
	background: linear-gradient(to right, #777, #222) !important;
	border-radius: 6px !important;
}

scrollbar thumb[orient="horizontal"]:active {
	background: linear-gradient(#777, #222) !important;
	border-radius: 6px !important;
}
