...
set _SOURCE_FILE="%~dp0Inst_files\chrome\MultiRowTab-scrollable-TabsBelow.uc.js"
set _SOURCE_FILE2="%~dp0Inst_files\chrome\Userchrome.xml"
set _SOURCE_FILE3="%~dp0Patch_files\Userchrome.css"
